...
public class Casa {
	...
	public void setPlanta(String _planta) {
		this.planta = _planta;
	}
	...
	public Casa(String _calle, String _planta, String _numero, int _num_habitaciones, int _metros_cuadrados,
			int _cod_postal) {
		this.calle = _calle;
		this.planta = _planta;
		this.numero = _numero;
	...
	void mostrarInfo() {
		System.out.println("Mostramos la información del casa");
		System.out.println("Calle: " + this.getCalle());
		System.out.println("Planta: " + this.getPlanta() + this.getNumero());
		System.out.println("Numero de habitaciones: " + this.getNum_habitaciones());
