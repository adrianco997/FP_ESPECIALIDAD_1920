...
public class Silla {
	...
	public Silla(double _anchura, double _largura, double _altura, String _material) {
		this.anchura = _anchura;
		this.largura = _largura;
		this.altura = _altura;
		this.material = _material;
	...
	void mostrarInfo() {
		System.out.println("Mostramos la información de la silla");
