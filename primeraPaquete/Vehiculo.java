...
public class Vehiculo {
	...
	public Vehiculo(String _modelo, String _compañia, String _matricula, String _ult_revision, String _color,
			int _asientos) {
		this.modelo = _modelo;
		this.compañia = _compañia;
		this.matricula = _matricula;
	...
	void mostrarInfo() {
		System.out.println("Mostramos la información del vehiculo");
